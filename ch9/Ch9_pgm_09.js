...
var garden = new Place(
  "Zen Garden",
  "You are in a tranquil Zen garden, surrounded by meticulously raked gravel."
);

var player2 = new Player("Takumi", 60);
player2.place = garden;
player2.addItem("a bamboo flute");
player2.addItem("The Scroll of Serenity");

// Display each player's info
player1.showInfo("=");
player2.showInfo("=");

// Drop the last item in player1's items array
var droppedItem = player1.dropLastItem();
console.log(player1.name + " dropped " + droppedItem);

// Show player1's info after dropping an item
player1.showInfo("=");
